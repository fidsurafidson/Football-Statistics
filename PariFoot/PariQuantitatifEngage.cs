...
namespace PariFoot
{
    public class PariQuantitatifEngage
    {
        int id;
        int idMatch;
        int idUtilisateur1;
        ...
        public void setJeton1(int jetons1)
        {
            if (jetons1 < 0)
            {
                throw new Exception("Erreur : Jeton 1 negatif!!");
            }
            else
            {
                this.jeton1 = jetons1;
        ...
        public void setJeton2(int jetons2)
        {
            if (jetons2 < 0)
            {
                throw new Exception("Erreur : Jeton 2 negatif!!");
            }
            else
            {
                this.jeton2 = jetons2;
        ...
        public void setForfait1(int forfaits1)
        {
            if (forfaits1 < 0)
            {
                throw new Exception("Erreur : Forfait 1 negatif!!");
            }
            else
            {
        ...
        public void setForfait2(int forfaits2)
        {
            if (forfaits2 < 0)
            {
                throw new Exception("Erreur : Forfait 2 negatif!!");
            }
            else
            {
